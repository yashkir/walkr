"""
Django settings for walkr project.
...
# Set development vars if in development
if os.getenv('DEV'):
...
WSGI_APPLICATION = 'walkr.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR/'walkr'/'static']
